...
output_path = "/home/elicer/jny/video/output_video_v4.mp4"
log_path = "/home/elicer/jny/video/log_output_v4.csv"
save_plot_dir = "/home/elicer/jny/video/plots_v4"
segformer_path = "/home/elicer/jhj/Segformer_Train/Final/result/checkpoint-3000"
yolo_model_path = "/home/elicer/syh/train/weights/best.pt"

# 클래스 이름 및 범주 설정
class_names = [
    "Disabled Icon", "Women Icon", "No Parking Sign", "Traffic Cone",
     "Two-wheeled Vehicle", "Vehicle", "Human"
]
...
while cap.isOpened():
    ...
    risk_names = [class_names[int(box[5])] for box in boxes if get_category(int(box[5])) in ["Obstacle", "Moving"]]
