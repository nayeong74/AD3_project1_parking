...
output_path = "/home/elicer/jny/video/output/v5/train2_v5.mp4"
log_path = "/home/elicer/jny/video/output/v5/train2_v5_log.csv"
save_plot_dir = "/home/elicer/jny/video/output/v5/train2_v5_plots"
segformer_path = "/home/elicer/jhj/Segformer_Train/Final/result/checkpoint-3000"
yolo_model_path = "/home/elicer/jny/result/yolov8x_box_object_v1/weights/best.pt"
...
while cap.isOpened():
    ...
    for i in range(1, num_labels + 1):
        ...
        for box in boxes:
            ...
            # IoU 및 region 기준 조건 (NoParking 전용)
            iou_condition = False
            if category == "NoParking":
                ...
                if box_area > 0 and (intersection / box_area > 0.1):
                    iou_condition = True
                elif region_area > 0 and (intersection / region_area > 0.15):
                    iou_condition = True

            # 조건 둘 중 하나라도 만족해야만 인정
    ...
    risk_names = [class_names[int(box[5])] for box in boxes if get_category(int(box[5])) in ["Obstacle", "Moving", "NoParking"]]
